...
// SIGINT SIGKILL signals sent to the application or Internal Errors of the web server.
// It also provides some useful crypto functions to calculate Hashes(Sha, Md5 etc.)
//
package mserver
